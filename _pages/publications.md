...
1.  <font size="3em"> <b>Seung-Wook Kim</b>*, Seongyeol Kim, Jiah Kim, Seowon Ji, and Se-Ho Lee, "FedWSQ: Efficient federated learning with weight standardization and distribution-aware non-uniform quantization," 2025 (Submitted).
...
1. <font size="3em"> Seong-Yeol Kim, Chi-Hun Sung, and <b>Seung-Wook Kim</b>*, "Color Filter Array Mapping Using Generative Adversarial Networks," <i>KICS Journal</i>, 2024. (*corresponding author)
...
1. <font size="3em"> <b>Seung-Wook Kim</b>, Byeong-Doo Choi, Won-Jae Park, and Sung-Jea Ko, "2D histogram equalisation based on the human visual system," <i>Electronics Letters</i>, 2016.</font>
